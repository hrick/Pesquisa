...
class PesquisaActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pesquisaId = intent.getIntExtra("EXTRA_PESQUISA_ID",-1)
            ...
            listaPerguntas?.forEach { pergunta ->
                ...
                if (pergunta.opcoes?.isNotEmpty() == true) {
                    ...
                    pergunta.opcoes.forEach { opcao ->
                        ...
                        radioButton.id = Math.abs(pergunta.idPergunta!! + Random(4).nextInt())
    ...
    private fun salvarPesquisa() {
        if (pesquisa == null){
            pesquisa = Pesquisa(idPesquisa = Random(1000).nextInt())
